        ...
        <div class="leftside-navigation">
            <ul class="sidebar-menu" id="nav-accordion">
                ...
                <li class="sub-menu">
                    ...
                    <ul class="sub">
						<li><a href="{{URL::to('/adddiadiem')}}">Thêm điểm đến</a></li>
						<li><a href="{{URL::to('/showdiadiem')}}">Danh sách</a></li>
                    </ul>
                </li>
                <li class="sub-menu">
                    <a href="javascript:;">
                    ...
                    <ul class="sub">
						<li><a href="{{URL::to('/add-product')}}">Thêm quán ăn </a></li>
                ...
                <li class="sub-menu">
                    <a href="javascript:;">
                        <i class="fa fa-book"></i>
                        <span>Quản lý nơi mua sắm</span>
                    </a>
                    <ul class="sub">
						<li><a href="{{URL::to('/add-slide')}}">Thêm nơi mua sắm</a></li>
						<li><a href="{{URL::to('/all-slide')}}">Thêm nơi mua sắm</a></li>
                    </ul>
                </li>
 ...
 <!-- footer -->
		  <div class="footer">
			<div class="wthree-copyright">
			  <p>© 2020 Admin. All rights reserved | Webgameandroid</a></p>
			</div>
		  </div>
  <!-- / footer -->
</section>
